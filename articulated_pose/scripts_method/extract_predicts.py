...
def main():
    ...
    with open(
        f"{os.environ['DATA_DIR']}/data/arctic_data/data/splits_json/protocol_{args.setup}.json",
        "r",
    ) as f:
    ...
    elif args.extraction_mode in ["analyze_errors"]:
        from src.extraction.keys.analyze_errors import KEYS
    ...
    elif args.extraction_mode in ["eval_hand"]:
        from src.extraction.keys.eval_hand import KEYS
    elif args.extraction_mode in ["vis_hand"]:
        from src.extraction.keys.vis_hand import KEYS
    else:
