...
class Omni3DEvaluationHelper:
    ...
    def evaluate(self, dataset_name):
        ...
        extras_AP25, extras_AP50, extras_AP70, extras_APn, extras_APm, extras_APf = (np.nan,)*6
        if not self.only_2d:
            # extras_AP15 = results['bbox_3D']['AP15']
            extras_AP25 = results['bbox_3D']['AP25']
            extras_AP50 = results['bbox_3D']['AP50']
            extras_AP70 = results['bbox_3D']['AP70']
        ...
        self.results_analysis[dataset_name] = {
            ...
            "AP3D@25": extras_AP25, "AP3D@50": extras_AP50, "AP3D@70": extras_AP70,
    ...
    def summarize_all(self,):
        ...
        metrics = ["AP", "AP25", "AP50", "AP70", "APn", "APm", "APf"]
...
class Omni3DEvaluator(COCOEvaluator):
    ...
    def _derive_omni_results(self, omni_eval, iou_type, mode, class_names=None):
        ...
        metrics = {
            ...
            "3D": ["AP", "AP25", "AP50", "AP70", "APn", "APm", "APf"],
        }[mode]
...
class Omni3DParams:
    ...
    def setDet3DParams(self):
        ...
        self.iouThrs = np.linspace(
            ...
            0.05, 0.7, int(np.round((0.7 - 0.05) / 0.05)) + 1, endpoint=True
        )
...
class Omni3Deval(COCOeval):
    ...
    def summarize(self):
        ...
        def _summarizeDets(mode):
            ...
            thres = [0.5, 0.75, 0.95] if mode == "2D" else [0.25, 0.50, 0.70]
